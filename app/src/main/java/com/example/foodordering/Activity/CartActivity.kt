...
@Composable
fun CartList(cartItems: ArrayList<FoodModel>, managmentCart: ManagmentCart, onItemChange: () -> Unit) {
...
fun calculatorCart(managmentCart: ManagmentCart, tax: MutableState<Double>) {
    var percenTax = 0.02
    tax.value = Math.round((managmentCart.getTotalFee() * percenTax) * 100) / 100.0
}